...
2. Note that neural metrics (such as comet-22 in the table above) may not cover your languages - thus, results for language pairs containing uncovered languages are unreliable (e.g., Unbabel/wmt22-comet-da does not cover Chuvash lmao)