...
from eeve.utils.datatrove import create_io_object, create_reader_and_writer
...
def minhash_deduplication(
    ...
    minhash_config_obj = MinhashConfig(hash_config=hash_config_obj, **minhash_config)
...
def run_minhash_deduplication(path_to_yaml_config: str) -> None:
    ...
    EXCLUSION_WRITER = (
        ...
        if yaml_config.get("exclusion_writer")
        else None
    )
